...
local landSquare2 = display.newImage( "./assets/sprites/landSquare.png" )
landSquare2.x = 1520
landSquare2.y = display.contentHeight - 1000
landSquare2.id = "land Square2"
physics.addBody( landSquare2, "dynamic", { 
    friction = 0.5, 
    bounce = 0.3 
    } )
local landSquare3 = display.newImage( "./assets/sprites/landSquare.png" )
landSquare3.x = 1520
landSquare3.y = display.contentHeight - 1000
landSquare3.id = "land Square"
physics.addBody( landSquare3, "dynamic", { 
    friction = 0.5, 
    bounce = 0.3 
    } )
local landSquare4 = display.newImage( "./assets/sprites/landSquare.png" )
landSquare4.x = 1520
landSquare4.y = display.contentHeight - 1000
landSquare4.id = "land Square"
physics.addBody( landSquare4, "dynamic", { 
    friction = 0.5, 
    bounce = 0.3 
    } )
...
function shootButton:touch( event )
    if ( event.phase == "began" ) then
        ...
        aSingleBullet:setLinearVelocity( 999591999999500, 0 )
